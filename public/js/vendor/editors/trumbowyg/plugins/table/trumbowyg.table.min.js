    ...
    plugins: {
      table: {
        init: function (l) {
          ...
          var a = {
              fn: function () {
                ...
                var t = 'table',
                  ...
                  n = {
                    class:
                      a + '-' + 'table ' + a + ' ' + l.o.prefix + 'fixed-top',
                  };
                n['data-' + a] = t;
                var b = e('<div/>', n);
                if (
                  ...
                  b.append(l.buildSubBtn('tableAddRowAbove')),
                    b.append(l.buildSubBtn('tableAddRow')),
                    b.append(l.buildSubBtn('tableAddColumnLeft')),
                    b.append(l.buildSubBtn('tableAddColumn')),
                    b.append(l.buildSubBtn('tableDeleteRow')),
                    b.append(l.buildSubBtn('tableDeleteColumn')),
                    b.append(l.buildSubBtn('tableDestroy'));
                else {
                  var r = e('<table/>');
                  e('<tbody/>').appendTo(r);
                  for (var i = 0; i < l.o.plugins.table.rows; i += 1)
                    for (
                      var s = e('<tr/>').appendTo(r), u = 0;
                      u < l.o.plugins.table.columns;
                      u += 1
                    )
                      e('<td/>').appendTo(s);
                  r.find('td').on('mouseover', o),
                    r.find('td').on('mousedown', d),
                    b.append(r),
                    b.append(e('<div class="trumbowyg-table-size">1x1</div>'));
                }
                l.dropdown(t);
              },
            },
            o = function (t) {
              ...
              for (var d = 0; d <= o; d += 1)
                for (var n = 0; n <= a; n += 1)
                  l.find('tr:nth-of-type(' + (d + 1) + ')')
                    .find('td:nth-of-type(' + (n + 1) + ')')
                    .addClass('active');
            ...
            d = function () {
              ...
              e('<tbody/>').appendTo(t),
                l.o.plugins.table.styler &&
                  t.attr('class', l.o.plugins.table.styler);
              for (
                var a = this.cellIndex, o = this.parentNode.rowIndex, d = 0;
                d <= o;
                d += 1
              )
            ...
            n = {
              ...
              fn: function () {
                ...
                if (o.length > 0) {
                  for (
                    var d = e('<tr/>'), n = 0;
                    n < o.find('tr')[0].childElementCount;
                    n += 1
                  )
                    e('<td/>').appendTo(d);
                  a.after(d);
          ...
          l.addBtnDef('table', a),
            l.addBtnDef('tableAddRowAbove', b),
            l.addBtnDef('tableAddRow', n),
            l.addBtnDef('tableAddColumnLeft', i),
            l.addBtnDef('tableAddColumn', r),
            l.addBtnDef('tableDeleteRow', u),
            l.addBtnDef('tableDeleteColumn', f),
            l.addBtnDef('tableDestroy', s);
        },
      },
    },
  });
