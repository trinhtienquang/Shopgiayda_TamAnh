...
!(function (n) {
      ...
      n.each(t, function (n, t) {
        var i = 'mention-' + n,
          r = {
            ...
            fn: function () {
              return (
                o.execCmd('insertHTML', o.o.plugins.mention.formatResult(t)), !0
              );
            },
          };
  ...
  n.extend(!0, n.trumbowyg, {
    langs: {
      ...
      da: { mention: 'Nævn' },
      et: { mention: 'Maini' },
      fr: { mention: 'Mentionner' },
      hu: { mention: 'Említ' },
      ko: { mention: '언급' },
      pt_br: { mention: 'Menção' },
    ...
    plugins: {
      mention: {
        init: function (e) {
          ...
          var i = { dropdown: o(e.o.plugins.mention.source, e) };
