!(function (e) {
  ...
  function l(t, l) {
    ...
    a.find('span[style*="font-size"]').contents().unwrap(),
      a.replaceWith(function () {
        return e('<span/>', { css: { 'font-size': l }, html: this.innerHTML });
      }),
      e(t.range.startContainer.parentElement)
        .find('span[style=""]')
        .contents()
        .unwrap(),
      t.restoreRange(),
  ...
  function a(t) {
    var a = [];
    if (
      (e.each(t.o.plugins.fontsize.sizeList, function (e, s) {
        t.addBtnDef('fontsize_' + s, {
          text:
            '<span style="font-size: ' +
            s +
            ';">' +
            (t.lang.fontsizes[s] || s) +
            '</span>',
          hasIcon: !1,
          fn: function () {
            l(t, s);
  ...
  e.extend(!0, e.trumbowyg, {
    plugins: {
      fontsize: {
        init: function (l) {
          (l.o.plugins.fontsize = e.extend({}, t, l.o.plugins.fontsize || {})),
            l.addBtnDef('fontsize', { dropdown: a(l) });
        },
      },
    },
  });
