!(function (e) {
  ...
  var s = function (i) {
    (this.resizeCanvas = document.createElement('canvas')),
      ...
      (this.ctx = null),
      (this.resizeImg = null),
      (this.pressEscape = function (e) {
        e.reset();
      }),
      (this.pressBackspaceOrDelete = function (t) {
        e(t.resizeCanvas).remove(),
          (t.resizeImg = null),
          null !== i && (i.syncCode(), i.$c.trigger('tbwchange'));
      });
    var s,
      n,
      r = !1,
      ...
      h = function (e, i, t, s, n) {
        return (
          i.translate(0.5, 0.5),
          (i.lineWidth = 1),
          i.drawImage(t, 5, 5, s - 10, n - 10),
          i.beginPath(),
          i.rect(5, 5, s - 10, n - 10),
          i.stroke(),
          i.beginPath(),
          (i.fillStyle = 'rgb(255, 255, 255)'),
          i.rect(s - 10, n - 10, 9, 9),
          i.fill(),
          i.stroke(),
          o(e),
          i
    ...
    (this.init = function () {
      ...
      (this.reset = function () {
        null !== this.resizeImg &&
          ...
          e(this.resizeCanvas).replaceWith(e(this.resizeImg)),
      ...
      (this.setup = function (o, c) {
        ...
        (r = !0),
          (this.resizeCanvas.width = e(this.resizeImg).width() + 10),
          (this.resizeCanvas.height = e(this.resizeImg).height() + 10),
          (this.resizeCanvas.style.margin = '-5px'),
          (this.ctx = this.resizeCanvas.getContext('2d')),
          e(this.resizeImg).replaceWith(e(this.resizeCanvas)),
          h(
            this.resizeCanvas,
            this.ctx,
            this.resizeImg,
          ...
          e(this.resizeCanvas)
            .on('mousemove', function (e) {
              var i = Math.round(e.clientX - s),
                ...
                r = a;
              u.ctx.rect(
                u.resizeCanvas.width - 10,
                u.resizeCanvas.height - 10,
                9,
                9,
              ),
                r !== (a = u.ctx.isPointInPath(i, t)) &&
                  (this.style.cursor = a ? 'se-resize' : 'default');
            })
            .on('keydown', function (e) {
              if (u.isActive()) {
                ...
                27 === i
                  ? u.pressEscape(u)
                  : (8 !== i && 46 !== i) || u.pressBackspaceOrDelete(u);
              }
            })
            .on('focus', t)
            .on('blur', function () {
        ...
        init: function (n) {
          ...
          function o() {
            n.$ed
              ...
              .on('click', function (e) {
                a.isActive() && a.reset(),
                  a.setup(this, n.o.plugins.resizimg.resizable),
                  t(e);
              });
          }
          (this.destroyResizable = function () {
            ...
            (n.o.plugins.resizimg = e.extend(
              !0,
              {},
              i,
              n.o.plugins.resizimg || {},
              {
                resizable: {
                  resizeWidth: !1,
                  onDragStart: function (e, i) {
                    ...
                    if (s < i.width() - t.minSize || r < i.height() - t.minSize)
                      return !1;
                  },
                  onDrag: function (e, i, t, s) {
                    var r = n.o.plugins.resizimg;
                    return (
                      s < r.minSize && (s = r.minSize),
                      (s -= s % r.step),
                      i.height(s),
                      !1
                    );
            ...
            n.$c.on('tbwinit', function () {
              o(),
                n.$ed.on('click', function (i) {
                  e(i.target).is('img') ||
                    i.target.id === a.canvasId() ||
                    (t(i), a.reset(), n.syncCode(), n.$c.trigger('tbwchange'));
                }),
                n.$ed.on('scroll', function () {
                  a.reCalcOffset();
                });
            }),
            n.$c.on('tbwfocus tbwchange', o),
            n.$c.on('tbwresize', function () {
              a.reCalcOffset();
            }),
