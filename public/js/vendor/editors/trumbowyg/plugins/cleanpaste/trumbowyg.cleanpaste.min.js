                ...
                var a = (r.originalEvent || r).clipboardData.getData('Text'),
                  ...
                  g =
                    ((l = (l = (l = (l = (l = (l = (l = (l = (l = a.trim())
                      ...
                      })).replace(/<b(\s+|>)/g, '<strong$1')).replace(
                      /<\/b(\s+|>)/g,
                      '</strong$1',
                    )).replace(/<i(\s+|>)/g, '<em$1')).replace(
                      /<\/i(\s+|>)/g,
                      '</em$1',
                    ...
                    (l = (l = (l = (l = (l = l.replace(
                      ...
                      return e.replace(/ ([^=]+)="[^"]*"/g, function (e, t) {
                        return -1 !== ['alt', 'href', 'src', 'title'].indexOf(t)
                          ? e
                          : '';
                      });
                      ...
                      /<(div|span|style|meta|link).*?>/gi,
                      '',
                    )),
                  o = e(g)[0] || t.doc.createTextNode(g);
                '' === t.$ed.html()
                  ? t.$ed[0].appendChild(o)
                  : (c.setStartAfter(n),
                    c.setEndAfter(n),
                    t.doc.getSelection().removeAllRanges(),
                    t.doc.getSelection().addRange(c),
                    t.range.insertNode(o)),
                  (c = t.doc.createRange()).setStartAfter(o),
                  c.setEndAfter(o),
                  t.doc.getSelection().removeAllRanges(),
                  t.doc.getSelection().addRange(c),
                  r.stopPropagation(),
