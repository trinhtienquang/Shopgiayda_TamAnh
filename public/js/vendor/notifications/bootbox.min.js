...
!(function (e, t) {
        ...
        buttons: (function (e, t) {
          for (var o = {}, a = 0, r = e.length; a < r; a++) {
            var n = e[a],
              ...
              l = n.toUpperCase();
            o[i] = {
              label: ((s = l), (c = t), (p = b[c]), p ? p[s] : b.en[s]),
            };
          }
          var s, c, p;
          return o;
  ...
  function x(e) {
    e.target === e.data.dialog[0] &&
      (e.data.dialog.off('escape.close.bb'), e.data.dialog.off('click'));
  }
  function k(e, t, o) {
    e.stopPropagation(),
      e.preventDefault(),
  ...
  return (
    ...
    (d.dialog = function (e) {
      ...
      if (
        ...
        e.reusable || o.one('hide.bs.modal', { dialog: o }, x),
        e.onHide)
      ) {
        if (!p.isFunction(e.onHide))
          throw new Error('Argument supplied to "onHide" must be a function');
        o.on('hide.bs.modal', e.onHide);
      }
      if (
        (e.reusable || o.one('hidden.bs.modal', { dialog: o }, y), e.onHidden)
      ) {
        if (!p.isFunction(e.onHidden))
          throw new Error('Argument supplied to "onHidden" must be a function');
        o.on('hidden.bs.modal', e.onHidden);
      }
      if (e.onShow) {
        if (!p.isFunction(e.onShow))
          throw new Error('Argument supplied to "onShow" must be a function');
        o.on('show.bs.modal', e.onShow);
      }
      if ((o.one('shown.bs.modal', { dialog: o }, v), e.onShown)) {
        if (!p.isFunction(e.onShown))
    ...
    (d.prompt = function () {
      ...
      return (
        (t = d.dialog(r)).off('shown.bs.modal', v),
