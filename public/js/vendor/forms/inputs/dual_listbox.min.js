    ...
    d = class {
      ...
      _initializeSortButtons() {
        ...
        t.classList.add('dual-listbox__button'),
          (t.innerHTML = this.upButtonText),
          t.addEventListener('click', (i) => this._onSortButtonClick(i, _));
        let e = document.createElement('button');
        e.classList.add('dual-listbox__button'),
          (e.innerHTML = this.downButtonText),
          e.addEventListener('click', (i) => this._onSortButtonClick(i, L));
      ...
      _sortUnderlyingSelectOptions(t, e) {
        let s = this.selected[t].getAttribute('data-id'),
          ...
          n = [...this.select.children].findIndex((o) => o.value === i),
