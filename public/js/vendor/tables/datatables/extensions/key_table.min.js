...
(function (c) {
    ...
    _constructor: function () {
      ...
      b.on('column-reorder' + d, function (f, q, r) {
        (f = a.s.lastFocus) &&
          f.cell &&
          ((q = f.relative.column),
          (f.cell[0][0].column = r.mapping.indexOf(q)),
          (f.relative.column = r.mapping.indexOf(q)));
      });
        ...
        c(k).on('paste' + e, function (d) {
          ...
          !p ||
            ...
            h.clipboardData && h.clipboardData.getData
              ...
              : g.clipboardData &&
                g.clipboardData.getData &&
                (f = g.clipboardData.getData('text/plain')),
            d
              ? ((g = b._inlineOptions(p.cell.index())),
                d
                  .inline(g.cell, g.field, g.options)
                  .set(d.displayed()[0], f)
                  .submit())
              : (p.cell.data(f), a.draw(!1)));
        }));
    },
    _columns: function () {
      var a = this.s.dt,
    ...
    _focus: function (a, b, e, d) {
      ...
      if (this.s.enable) {
        ...
        if (-1 !== l.length && (a < l.start || a >= l.start + l.length))
          ...
          if (e === m || !0 === e)
            this._scroll(c(h), c(k.body), f, 'offset'),
              (e = p.table().body().parentNode),
              e !== p.table().header().parentNode &&
                ((e = c(e.parentNode)), this._scroll(e, e, f, 'position'));
          this.s.lastFocus = {
            cell: l,
            node: l.node(),
            relative: {
          ...
          'right' === b
            ...
            : 'left' === b
              ...
              : 'up' === b
                ? f--
                : 'down' === b && f++,
          0 <= f && f < p && -1 !== c.inArray(q, l)
            ? (a && a.preventDefault(), this._focus(f, q, !0, a))
            : e && this.c.blurable
              ? this._blur()
              : a && a.preventDefault());
      }
  ...
  n.ext.selector.cell.push(function (a, b, e) {
    ...
    for (var g = 0, p = e.length; g < p; g++)
      ((!0 === b && a.focused(e[g])) || (!1 === b && !a.focused(e[g]))) &&
        d.push(e[g]);
    return d;
  });
