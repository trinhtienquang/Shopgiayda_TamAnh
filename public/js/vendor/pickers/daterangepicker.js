...
(function (root, factory) {
  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    if (typeof options.ranges === 'object') {
      ...
      var list =
        '<ul class="dropdown-menu d-block wmin-0 border-0 bg-transparent shadow-none position-static rounded-0">';
      for (range in this.ranges) {
        list +=
          '<li class="dropdown-item" data-range-key="' +
          range +
          '">' +
          range +
          '</li>';
  ...
  DateRangePicker.prototype = {
    ...
    renderCalendar: function (side) {
      ...
      if (this.showDropdowns) {
        ...
        var monthHtml =
          '<select class="form-select form-select-sm monthselect">';
        for (var m = 0; m < 12; m++) {
          if (
