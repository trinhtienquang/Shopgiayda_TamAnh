!(function () {
  ...
  function re(t, i) {
    ...
    if (
      ...
      void 0 !== i.todayBtn &&
        (i.todayBtn
          ? _(t.controls.todayBtn)
          : W(
              t.controls.todayBtn,
              t.controls.todayBtn.parentElement.classList.add(
                'today-btn-hidden',
              ),
            )),
    ...
    void 0 !== i.clearBtn &&
      (i.clearBtn
        ? _(t.controls.clearBtn)
        : W(
            t.controls.clearBtn,
            t.controls.clearBtn.parentElement.classList.add('clear-btn-hidden'),
          ));
  }
  function de(e) {
