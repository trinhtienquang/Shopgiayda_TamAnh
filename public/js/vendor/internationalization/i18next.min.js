              ...
              value: function (t, n, r) {
                ...
                if (p && 'cimode' === p.toLowerCase()) {
                  if (g) {
                    ...
                    return i
                      ? ((d.res = ''.concat(f).concat(h).concat(c)), d)
                ...
                if (
                  ...
                  (v = v.join(O)) && (v = this.extendTranslation(v, t, n, r));
                else {
                  var R = !1,
                    N = !1,
                  ...
                  !this.isValidLookup(v) && E && ((R = !0), (v = I)),
                    this.isValidLookup(v) || ((N = !0), (v = c));
                  var A =
                  ...
                  if (N || R || T) {
                    ...
                    if ('fallback' === this.options.saveMissingTo && K && K[0])
                      for (var B = 0; B < K.length; B++) U.push(K[B]);
                    else
                      'all' === this.options.saveMissingTo
                        ? (U = this.languageUtils.toResolveHierarchy(
                            n.lng || this.language,
                          ))
                        : U.push(n.lng || this.language);
                    var M = function (e, t, r) {
                      var i = E && r !== v ? r : A;
                      o.options.missingKeyHandler
                        ? o.options.missingKeyHandler(e, f, t, i, T, n)
                        : o.backendConnector &&
                          o.backendConnector.saveMissing &&
                          o.backendConnector.saveMissing(e, f, t, i, T, n),
              ...
              value: function (e, t, n, r, o) {
                ...
                if (this.i18nFormat && this.i18nFormat.parse)
                  e = this.i18nFormat.parse(
                    e,
                    D(D({}, this.options.interpolation.defaultVariables), n),
                    r.usedLng,
                    r.usedNS,
                    r.usedKey,
                    { resolved: r },
            ...
            var o = this,
              i = function t(n, i) {
                ...
                var l = o.options.keySeparator || '.',
                  f = a.keyPrefix
                    ? ''.concat(a.keyPrefix).concat(l).concat(n)
                    : n;
                return o.t(f, a);
              };
            return (
